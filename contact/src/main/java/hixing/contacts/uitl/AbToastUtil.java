...
public class AbToastUtil {
	...
	public static void longShow(Context context, CharSequence text, int gravity, int xOffset, int yOffset) {
	...
	public static void longShow(Context context, int textResId, int gravity, int xOffset, int yOffset) {
		show(context, textResId, TOAST_SHOW_LONG_TIME, gravity, xOffset, yOffset);
	}
	...
	public static void shortShow(Context context, CharSequence text, int gravity, int xOffset, int yOffset) {
	...
	public static void shortShow(Context context, int textResId, int gravity, int xOffset, int yOffset) {
		show(context, textResId, TOAST_SHOW_SHORT_TIME, gravity, xOffset, yOffset);
	}
	 ...
	 *            Toast显示位置Y坐标偏移像素值
	 */
	public static void show(Context context, int resId, int duration, int gravity, int xOffset, int yOffset) {
		try {
			if (context == null) {
				return;
			}
