...
import com.ffly.demo.Base64;
import com.ffly.demo.CharsetUtils;
import com.ffly.demo.EncondingUtil;
    ...
    private String handleOneValue(String value, String targetCharset, String encoding) {
        if (encoding != null) {
            if (encoding.equals("BASE64") || encoding.equals("B")) {
                ...
                try {
					value=EncondingUtil.qpDecodingUTF8(value);
				} catch (Exception e2) {
					// TODO Auto-generated catch block
					e2.printStackTrace();
				}
                String quotedPrintable = builder.toString();
                Log.i("TAG", "quotedPrintable--->"+quotedPrintable);
