...
public class RegexUtil {
	 ...
	 * 车牌号码Pattern
	 */
	public static final Pattern PLATE_NUMBER_PATTERN = Pattern.compile("^[\u0391-\uFFE5]{1}[a-zA-Z]{1}[a-zA-Z0-9]{5}$");
	 ...
	 * 手机号码Pattern
	 */
	public static final Pattern MOBILE_NUMBER_PATTERN = Pattern.compile("^((13[0-9])|(15[^4,\\D])|(18[0-9,5-9])|(17[0-9]))\\d{8}$");
