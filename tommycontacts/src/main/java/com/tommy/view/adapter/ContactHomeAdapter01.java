...
public class ContactHomeAdapter01 extends BaseAdapter {
	...
	public ContactHomeAdapter01(Context context, List<ContactBean> list, List<String> numberList, QuickAlphabeticBar alpha) {
